function [Wavelengths_l, Wavelengths_r,InterpolatedWavelengths, Ks]=InterpolateWavelengths5(Parameters)
...
% 11/20/2024 octoplus new lens (Zebel and vlad)
position_l_white= [5 42.4 115.7 188.8 262.8 336.2 409.7 483.8 558 632.9 707.5 781.9 857 933 993]; %pixel numbers
position_r_red= [56.5 92.1 162.6 232.2 303.9 375 445.8 517.8 589.9 662.9 735.8 808.6 882 956.8 1015.8]; %pixel numbers 
wave_sample= [802.45 805.01 810.04 815.02 820.06 825.07 830.04 835.05 840.04 845.07 850.06 855.01 860.01 865.05 869];
...
Wavelengths_l=1e-9*interp1([Start1:Start1+OriginalLineLength1-1],lamda_l,xx1)';
xx2=linspace(Start2-1024,Start2+OriginalLineLength2-1025,PaddingLength);
Wavelengths_r=1e-9*interp1([Start2-1024:Start2+OriginalLineLength2-1025],lamda_r,xx2)';
...
Ks=linspace(maxK,minK,OriginalLineLength1)';
